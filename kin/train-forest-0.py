...
def do_training():
    ...
    out_dir ='./resnet34_out_layer0123_freeze'
    ...
    pretrained_file = '/home/ytchan/.torch/models/resnet34-333f7ec4.pth'
    #pretrained_file = '/home/ytchan/.torch/models/resnet50-19c8e357.pth'
    ...
    train_dataset = KgForestDataset('train_35000',  #'train-32479',#'train-32479-unsuper-31936' , #'train-3000',#'train-8000',#'debug-32', #'train-3000',#'train-8000',###
                                    transform=[
                                        lambda x: augment(x),
    ...
    test_dataset = KgForestDataset('val_5000', #'debug-32', #'train-3000',#'valid-8000',
                                    transform=[
                                        lambda x: img_to_tensor(x),
                                    ],
                                    height=SIZE, width=SIZE, ext=EXT,
                                    is_preload=True,
                                    label_csv='train_v2.csv' #'train_v2.csv'
                                    )
